...
<body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="text-center h2">بيانات الخصوصية لتطبيق شركة بحر </p>
                <p class="font-weight-bold h5 text-center">نحن نحرص على حماية خصوصيتك وجمع المعلومات الشخصية الخاصة بك
                    بطريقة آمنة ومسؤولة. هذا بيان الخصوصية يوضح كيفية جمعنا واستخدمنا ونحن نعمل على حماية المعلومات
                    الشخصية التي تقدمها لنا عند استخدامك لتطبيق شركة بحر.</p>
                <p>
                    <span class="font-weight-bold h6 ">
                        1-جمع المعلومات:
                    </span>
                    يتم جمع المعلومات الشخصية التي تقدمها لنا عند التسجيل في التطبيق، وذلك لتحسين
                    خدماتنا وتحسين تجربتك مع التطبيق.
                </p><br>
                <p>
                    <span class="font-weight-bold h6 ">
                        2-استخدام المعلومات:
                    </span>
                    يتم استخدام المعلومات الشخصية التي تم جمعها لتحسين تجربتك مع التطبيق وتقديم خدماتنا بشكل
                    أفضل، ولن نقوم بمشاركة هذه المعلومات مع أي جهة خارجية.
                </p>
                <p>
                    <span class="font-weight-bold h6 ">
                    ...
                    نحن نتعهد بحماية خصوصية معلوماتك الشخصية ونتخذ جميع الإجراءات اللازمة لحمايتها
                    من الوصول غير المصرح به أو الاستخدام أو الإفشاء
                </p>
                <p>
                    <span class="font-weight-bold h6 ">
                        4-التغييرات في بيان الخصوصية </span>

                    يحق لنا تغيير بيان الخصوصية في أي وقت، وسيتم إشعار المستخدمين بأي
                    تغييرات.
                </p>
            </div>
        </div>

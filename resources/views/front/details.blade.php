        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">تفاصيل المشروع</h1>
                    <a href="{{route('product',1)}}" class="h5 text-white">المشاريع</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{route('index')}}" class="h5 text-white">الصفحة الرئسية</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="{{$product->image_path}}" alt="">

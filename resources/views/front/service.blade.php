        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="{{route('service')}}" class="nav-item nav-link active">خدماتنا</a>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">خدمتنا</h1>
                    <a href="{{route('about')}}" class="h5 text-white">من نحن</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{route('product')}}" class="h5 text-white">مشاريع </a>
                </div>
            </div>
        </div>
    </div>

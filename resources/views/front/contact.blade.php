    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"> {{$contect->tittle}}</h5>
                <h1 class="mb-0">{{$contect->description}}</h1>
            </div>
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">البريد الالكتروني</h5>
                            <h4 class="text-primary mb-0">{{$contect->email}}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">{{$contect->address}}</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action="{{ route('comment') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" name="name" class="form-control border-0 bg-light px-4" placeholder="الاسم" style="height: 55px;">
                            </div>
                            <div class="col-md-6">
                                <input type="email" name="email" class="form-control border-0 bg-light px-4" placeholder="البريد الالكتروني" style="height: 55px;">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="tittle" class="form-control border-0 bg-light px-4 py-3" placeholder="عنوان الموضوع" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" name="comment" rows="4" placeholder="الموضوع"></textarea>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit">ارسال الطلب</button>
                            </div>
                        </div>
                    </form>
                </div>

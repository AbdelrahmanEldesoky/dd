        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn"> من نحن</h1>
                    <a href="{{route('service')}}" class="h5 text-white"> خدماتنا</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{'index'}}" class="h5 text-white">الرئسية </a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <a href="{{route('comment_get')}}" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">تقديم طلب</a>
                </div>

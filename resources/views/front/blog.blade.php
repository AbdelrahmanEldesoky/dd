    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="{{route('index')}}" class="navbar-brand p-0">
                <h1 class="m-0"><i class="fa fa-user-tie me-2"></i>شركة هندسية</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="{{route('index')}}" class="nav-item nav-link ">الصفحة الرئسية</a>
                    <a href="{{route('about')}}" class="nav-item nav-link">من نحن</a>
                    <a href="{{route('service')}}" class="nav-item nav-link">خدماتنا</a>
                    <a href="{{route('product',1)}}" class="nav-item nav-link active">مشاريع</a>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">مشاريع</h1>
                    <a href="{{route('feature')}}" class="h5 text-white">لماذا نحن</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{route('service')}}" class="h5 text-white">خدمتنا</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    ...
                                    <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href="">{{$product->category->name}}</a>
                                </div>
                                <div class="p-4">
                                    ...
                                    <a class="text-uppercase" href="{{route('product_id',$product->id)}}">قراءة المذيد <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div-- class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="{{route('product',$category->id)}}"><i class="bi bi-arrow-right me-2"></i>{{$category->name}}</a>
                            @endforeach
                            @endisset
                        </div>
                    </div>
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="{{$post->image_path}}" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">{{$post->tittle}}
                            </a>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        <img src="{{$plan->image_path}}" alt="" class="img-fluid rounded">
                    </div>
                    @endforeach
                    ...
                    <div class="wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="bg-light text-center" style="padding: 30px;">
                            ...
                            <a href="{{route('plan',$plan->id)}}" class="btn btn-primary py-2 px-4">قراءةالمزيد</a>
                        </div>
                        @endforeach
                    </div>
                    <!-- Plain Text End -->

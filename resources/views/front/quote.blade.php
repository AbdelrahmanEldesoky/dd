        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="{{route('home')}}" class="nav-item nav-link ">الصفحة الرئسية</a>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn"> طلب او شكوى </h1>
                    <a href="{{route('team')}}" class="h5 text-white"> فريق العمل</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{route('contact')}}" class="h5 text-white">تواصل معنا </a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-5">
                ...
                <form action="{{ route('comment') }}" method="post" enctype="multipart/form-data">
                    ...
                    {{ method_field('post') }}
                        ...
                        <div class="row g-3">
                            <div class="col-xl-12">
                                <input type="text" name="name" class="form-control bg-light border-0" placeholder="اسمك" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="email" name="email" class="form-control bg-light border-0" placeholder="البريد الالكتروي" style="height: 55px;">
                            </div>
                            <div class="col-xl-12">
                                <input type="text" name="tittle" class="form-control bg-light border-0" placeholder="عنوان الموضوع" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea name="comment"class="form-control bg-light border-0" rows="3" placeholder="الموضوع"></textarea>
                            </div>
                            <div class="col-12">
